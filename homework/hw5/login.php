...
<main>
    ...
    <label for="email" class="login_header">Email:</label>
    ...
    ?>
    <label for="password" class="login_header">Password:</label>
    ...
    ?>
    <label for="password" class="login_header">Confirm Your Password:</label>
